...
public class Questao47 {
    public static void main(String[] args) {
        ...
        System.out.println("Informe os dados dos pacientes. Digite \"fim\" no nome do último paciente.");
        ...
        while (true) {
            ...
            if (imc > limiteIMC) {
                System.out.println("Atenção, " + nome + "! Seu IMC está acima do limite recomendado.");
            }
        }
        ...
        if (totalIdadeHomens > 0) {
            ...
            System.out.println("Não há pacientes homens.");
        }
